...
Metodologia ágil: [Atlassian Trello](https://trello.com/pt-BR)
...
<p align="justify">Esta primeira API representou meu primeiro contato com o desenvolvimento de software em um projeto completo. Durante o semestre, tive a oportunidade de aprender os fundamentos da programação com Python, desenvolver interfaces utilizando Tkinter e compreender conceitos essenciais de modelagem de banco de dados com MySQL. Além do aprendizado técnico, a experiência em trabalhar em equipe, utilizar metodologias ágeis e participar do desenvolvimento de uma solução real marcou o início da minha formação na FATEC. Ao concluir este projeto, percebi que a programação e o desenvolvimento de sistemas exigem aprendizado contínuo, colaboração e dedicação, estabelecendo uma base sólida para os desafios que seriam enfrentados nos semestres seguintes.</p>
...
Metodologia ágil: [Atlassian JIRA](https://www.atlassian.com/br/software/jira)
...
- <p align="justify">Utilização de Spring Boot e Arquitetura rest.</p>
...
- <p align="justify"><b>Java / Spring Boot:</b> Uso com ajuda: criação de projeto web/microservice, empacotamento JAR com Tomcat embutido, configuração de POM.xml.</p>
- <p align="justify"><b>JPA / Hibernate:</b> Uso com ajuda: mapeamento objeto-relacional e CRUD com menos código repetitivo.</p>
- <p align="justify"><b>Thymeleaf:</b> Uso com ajuda: construção de views dinâmicas integradas ao padrão MVC.</p>
- <p align="justify"><b>PostgreSQL:</b> Uso com autonomia: modelagem, integração local e criação de triggers e procedures.</p>
- <p align="justify"><b>Metodologia Ágil (JIRA/Scrum):</b> Uso com autonomia: atuação como Scrum Master, planejamento e distribuição de tarefas da equipe.</p>
- <p align="justify"><b>GIT:</b> Uso com autonomia: controle de versão consolidado.

### Soft Skills:

- <p align="justify"><b>Organização:</b> Atuando simultaneamente como desenvolvedor e Scrum Master, precisei organizar minhas próprias entregas técnicas junto ao planejamento e acompanhamento das tarefas da equipe, estruturando as sprints no JIRA e garantindo que os prazos fossem cumpridos.</p>
...
<p align="justify">Esta API marcou uma nova etapa da minha formação ao unir responsabilidades técnicas e de gestão dentro da equipe. Além de aprofundar meus conhecimentos em desenvolvimento com Java, Spring Boot, JPA, Hibernate e PostgreSQL, tive a oportunidade de atuar pela primeira vez como Scrum Master, organizando as sprints e acompanhando o desenvolvimento do projeto. Essa experiência ampliou minha visão sobre o ciclo de desenvolvimento de software, mostrando que entregar uma solução de qualidade depende tanto do domínio técnico quanto da comunicação, planejamento e colaboração entre os integrantes da equipe. Ao final deste semestre, senti uma evolução significativa na minha autonomia, capacidade de liderança e maturidade para atuar em projetos mais complexos.</p>
...
- Utilização de Spring Boot e Arquitetura REST.
...
- <p align="justify"><b>Java:</b> Uso com ajuda: tratamento de exceções e manipulação de listas/arrays com dados do Oracle.</p> 
- <p align="justify"><b>Spring Boot / Spring Security / Spring Data:</b> Uso com ajuda: dashboard e cards via REST, criptografia de dados sensíveis, simplificação de operações com o banco.</p>
- <p align="justify"><b>PL/SQL:</b> Uso com autonomia: procedimentos armazenados e funções otimizadas para consulta, inserção e atualização de dados.</p>
- <p align="justify"><b>Oracle Autonomous Database:</b> Uso com ajuda: conexão via Wallet e modelagem de dados voltada às demandas da Embraer.</p>
- <p align="justify"><b>Metodologia Ágil (JIRA/Scrum):</b> Uso com autonomia: gestão de tempo e comunicação com cliente/PO em equipe reduzida.</p>

### Soft Skills:
- <p align="justify"><b>Gestão de Tempo:</b> Gerenciei o tempo de forma eficiente em um grupo com o menor número de participantes, superando desafios como baixas ao longo do semestre. Através de uma gestão eficaz, assegurei o desenvolvimento e a entrega do projeto dentro dos prazos estipulados nas sprints.</p>
...
<hr>
  ...
  <p align="center">
    São José dos Campos, Junho, 2026 &nbsp; | &nbsp; 
    <a href="#portfólio-api---tecnólogo-em-banco-de-dados">🏠 Voltar para o início da página</a>
  </p>
